!(function (t, e) {
  ...
  window.addEventListener("load", () => {
    const dataTabContainer = document.querySelectorAll(
      "[data-tab-container-one]"
    );
  ...
  document
    .querySelectorAll("[data-accordion-container-one]")
    .forEach((container) => {
      const triggers = container.querySelectorAll(".accordion-trigger");
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const navLinks = document.querySelectorAll(".nav-tabs");
  ...
  const selectCourseMobile = document.querySelectorAll(".select-course-mobile");
  const selectCourseDropdown = document.querySelectorAll(
  ...
  selectCourseMobile.forEach((selectCourseMobiles, index) => {
    selectCourseMobiles?.addEventListener("click", () => {
      selectCourseDropdown.forEach((dropdown) => {
  ...
  Array.from(selectCourseBtns).forEach((dropdown) => {
    dropdown.addEventListener("click", () => {
      ...
      selectCourseMobile.forEach((selectCourseMobiles) => {
        selectCourseMobiles.querySelector("span").textContent = textContent;
      });
    });
  });
  
  const toggleButton = document.querySelectorAll(".toggle-button");
  const courseToggle = document.querySelectorAll(".course-toggle");
  
  toggleButton.forEach((item, i) => {
    item.addEventListener("click", () => {
      toggleButton.forEach((item) => item.classList.remove("active"));
      item.classList.add("active");
      courseToggle.forEach((item) => item.classList.remove("active"));
      courseToggle[i].classList.add("active");
    });
  });
