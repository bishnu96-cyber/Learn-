...
.border-primary\/\[0\.30\] {
  border-color: rgb(112 67 227 / 0.3);
}
.border-primary\/\[0\.32\] {
...
.bg-primary\/\[0\.12\] {
  background-color: rgba(179, 227, 67, 0.12);
}
.bg-secondary {
...
.text-purple {
  color: rgb(154 116 253);
}
.text-secondary {
  color: rgb(38 23 78);
}
.text-secondary\/50 {
  color: rgba(219, 7, 7, 0.856);
}
.text-secondary\/60 {
...
.dark .anim-common {
  background: linear-gradient(93deg, #e8ee8e 4.12%, #f7eb3f 95.68%);
...
.button:hover {
  box-shadow: 0 14px 48px 0 rgba(255, 204, 0, 0.4);
}
...
.cardd {
  box-shadow: 0 -1px 29px 0 rgba(0, 0, 0, 0.08);
}
.special-discount::before {
  top: -10%;
  left: -5%;
...
.course-content-center::after {
  ...
  width: 4px;
  height: 80%;
  background-color: rgba(255, 204, 0, 0.19);
  top: 0;
  left: 50%;
  z-index: 0;
}
...
@media (max-width: 1280px) {
  ...
  .nav-area .hamburger.active span:first-child {
...
.conquer {
  background: linear-gradient(271deg, #fc0 -29.5%, #431f9f 79.96%);
  background-clip: text;
  -webkit-background-clip: text;
}
.instructors::before {
  border-radius: 763px;
  background: rgba(255, 204, 0, 0.31);
  filter: blur(100px);
  content: "";
  position: absolute;
  height: 446px;
...
.course-hero::after {
  background: right center/auto 100% no-repeat #fc0;
  height: 35%;
  content: "";
  position: absolute;
  top: 0;
...
.basic-shadow {
  box-shadow: 0 24px 28px 0 rgba(0, 0, 0, 0.15);
}
.submit-bg::after {
...
.course-content-list-box:hover {
  border-color: #fc0;
  box-shadow: 0 0 24px 0 rgba(255, 204, 0, 0.24);
}
.footer-gradient {
  background: #fc0;
}
...
.anim-common {
  ...
  background: linear-gradient(93deg, #ddbe0f 4.12%, #fc0 95.68%);
  background-clip: text;
  -webkit-background-clip: text;
}
.anim-common.active {
...
.equal-height-slider .swiper-slide {
  height: auto;
  border-radius: 15px;
  box-shadow: 1px 2px 5px rgba(255, 255, 255, 0.26);
}
.testimonial-nav {
  top: -100px;
  position: absolute;
...
@media (max-width: 767px) {
  ...
  .marquee {
    animation: 10s linear infinite marqueeHorizontal;
  }
  .marquee2 {
    animation: 10s linear infinite marqueeHorizontal2;
  }
...
background: linear-gradient(45deg, rgba(255,204,0,1) 16%, rgba(255,0,22,1) 49%);
}
...
.contact-whatsapp{
  ...
  z-index: 99999999;
  cursor: pointer;
  animation: 1.5s ease-out infinite upDown;
}
